    ...
    <div className='bg-white shadow-sm rounded-sm p-8 pb-12 mb-8'>
      ...
      <div className='mt-8'>
        <button
          ...
          className='font-light bg-gradient-to-r from-gray-400 via-gray-500 to-black text-xs lg:text-sm rounded mt-3 px-4 lg:px-6 py-2 shadow-md transition duration-300 transform hover:-translate-y-1 hover:shadow-lg inline-block hover:opacity-4 text-white'>
          Post Comment
        </button>
        {showSuccessMessage && (
